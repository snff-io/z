...
Promise<Db>async function connectToDatabase() {
...
Promise<void>async function addUnit(db: Db, unit: IUnit) {
...
Promise<string[]>function readNamesFromFile(filename: string) {
